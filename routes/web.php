...
Route::get('xoa-sp-gio-hang', [CartController::class, 'removeToCart'])->name('remove-to-cart');
Route::get('cap-nhat-gio-hang', [CartController::class, 'UpdateToCart'])->name('update-to-cart');
