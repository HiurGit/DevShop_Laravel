...
<div class="hero-section hero-background style-02">
        ...
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><span class="current-page">Chi tiết tin tức</span></li>
            </ul>
        </nav>
    </div>
            ...
            <div class="row">
                ...
                <div id="main-content" class="main-content col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="single-post-contain">
                        ...
                        <div class="post-head">
                            <div class="thumbnail">
                                <figure><img src="{{asset($article->image)}}" width="870" height="635" alt=""></figure>
                            </div>
                            <h2 class="post-name">{{$article->title}}</h2>
                            <p class="post-archive"><b class="post-cat">ORGANIC</b><span class="post-date"> {{date('d/m/Y',strtotime($article->created_at))}}</span><span class="author">Posted By: Braum J.Teran</span></p>
                        </div>
                        ...
                        <div class="comment-form">
                            <form action="#" method="post" name="frm-post-comment">
                                <p class="form-row">
                                    ...
                                    <a href="#" class="current-author"><img src="{{ asset('public/frontend')}}/assets/images/blogpost/viewer-avt.png" width="41" height="41" alt=""></a>
                                </p>
                            ...
                            <ol class="post-comments lever-0">
                                <li class="comment-elem">
                                    <div class="wrap-post-comment">
                                        ...
                                        <div class="cmt-inner">
                                            <div class="auth-info">
                                                <a href="#" class="author-contact"><img src="{{ asset('public/frontend')}}/assets/images/blogpost/author-02.png" alt="" width="29" height="28">Christiano Bale</a>
                                            ...
                                            <ol class="post-comments lever-1">
                                                <li class="comment-elem">
                                                    <div class="wrap-post-comment">
                                                        <div class="cmt-inner">
                                                            <div class="auth-info">
                                                                <a href="#" class="author-contact"><img src="{{ asset('public/frontend')}}/assets/images/blogpost/author-03.png" alt="" width="29" height="28">Samuel Godi</a>
                                                                <span class="cmt-time">4 days ago</span>
                                                            </div>
                                                            <div class="cmt-content">
                                ...
                                <ul class="posts">
                                    <li>
                                        <div class="wgt-post-item">
                                            <div class="thumb">
                                                <a href="#"><img src="{{ asset('public/frontend')}}/assets/images/blogpost/post-wgt-01.jpg" width="80" height="58" alt=""></a>
                                            </div>
                                            <div class="detail">
                                    ...
                                    <li>
                                        <div class="wgt-post-item">
                                            <div class="thumb">
                                                <a href="#"><img src="{{ asset('public/frontend')}}/assets/images/blogpost/post-wgt-02.jpg" width="80" height="58" alt=""></a>
                                            </div>
                                            <div class="detail">
                                                <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World</a></h4>
                                    ...
                                    <li>
                                        <div class="wgt-post-item">
                                            <div class="thumb">
                                                <a href="#"><img src="{{ asset('public/frontend')}}/assets/images/blogpost/post-wgt-03.jpg" width="80" height="58" alt=""></a>
                                            </div>
                                            <div class="detail">
                                                <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World</a></h4>
                                ...
                                <ul class="content">
                                    <li>
                                        <div class="wgt-twitter-item">
                                            <div class="author"><a href="#"><img src="{{ asset('public/frontend')}}/assets/images/blogpost/author.png" width="38" height="38" alt="author"></a></div>
                                            <div class="detail">
